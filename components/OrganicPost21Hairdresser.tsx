...
/**
 * 🎯 POST #21: KADEŘNICTVÍ - Reálný příběh
 * Slide-show: Setup → Problém → Strach → Řešení → Výsledek → CTA
 */

export function OrganicPost21Hairdresser() {
  ...
  return (
    <div className="relative w-full h-full bg-gradient-to-br from-slate-950 via-pink-950 to-slate-950 overflow-hidden">
      
      <AnimatePresence mode="wait">
        
        {/* SCÉNA 1: Setup - Vlastní salon */}
        {scene === 0 && (
          <motion.div
            key="scene1"
          ...
          >
            <div className="text-center max-w-2xl space-y-4">
              ...
              <p className="text-white/60 text-2xl">
                Vyučená, šikovná, vlastní prostor
              </p>
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                10 let zkušeností. Konečně svůj salon.
              </motion.p>
            </div>
          </motion.div>
        )}

        {/* SCÉNA 2: Problém - Všichni dělají to samé */}
        {scene === 1 && (
          <motion.div
            key="scene2"
          ...
          >
            ...
            <div className="space-y-4 max-w-xl w-full">
              ...
              >
                ...
                <p className="text-white/70 text-xl mt-2">Každá ulice, stejné služby</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-white/70 text-xl mt-2">Střih za 200 Kč, barva za 500 Kč</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-white/70 text-xl mt-2">Rezervace online, slevy, všude stejné</p>
              </motion.div>
            </div>
          </motion.div>
        )}
            ...
            <div className="text-center max-w-3xl space-y-6">
              ...
              <div className="bg-slate-900/60 backdrop-blur-md rounded-3xl p-10 border-2 border-white/10">
                <p className="text-4xl font-black text-white/90 italic leading-tight">
                  "Jak se <span className="text-red-400">odlišit</span>,<br/>
                  když všichni děláme<br/>
                  střihy a barvy?"
                </p>
              </div>
              <motion.p
              ...
              >
                Kalendář napůl prázdný. Konkurence snižuje ceny.
              </motion.p>
            </div>
          </motion.div>
        )}
            ...
            <div className="max-w-2xl space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-lg">
                      Přestaň dělat všechno. Najdi svou specialitu.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-2xl font-black text-white mb-1">
                      Specializace: kudrnaté vlasy
                    </div>
                    <p className="text-white/70 text-lg">
                      90% kadeřnic kudrny neumí. Ty budeš ta, co to zvládne.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-lg">
                      Uč je pečovat o kudrny doma. Staň se jejich expertkou.
                    </p>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="max-w-2xl space-y-4">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="text-4xl">✅</div>
                  <p className="text-2xl font-black text-white">
                    Zákaznice ji doporučují kamarádkám
                  </p>
                </div>
              </motion.div>
            </div>
        ...
        {scene === 5 && (
          ...
          >
            ...
            >
              Nemusíš dělat všechno. Stačí být nejlepší v jednom.
            </motion.div>
          </motion.div>
        )}
